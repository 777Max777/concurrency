...
public class MountTableRefresherThread //implements Supplier<MountTableRefresherThread>
extends Thread
{
...
//        setDaemon(true);
    ...
    public MountTableRefresherThread(String adminAddress) {
        this.adminAddress = adminAddress;
    }
...
//        return this;
    ...
    public void setManager(MountTableManager manager) {
        this.manager = manager;
    }
}
